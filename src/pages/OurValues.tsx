  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{ backgroundImage: `url('/img/value.webp')` }}
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <h1
            className="heading-page font-bold 
          ...
          <p
            className="body-large text-white animate-fade-in-up leading-relaxed"
                ...
                <CardContent className="p-8">
                  <div className="flex items-start space-x-6 rtl:space-x-reverse">
                    ...
                    <div className="flex-1">
                      <h2 className="heading-subsection font-semibold text-emdad-navy mb-4">
