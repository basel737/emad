...
const translations = {
  en: {
    ...
    'numbers.description': 'Emdad Mubasher\'s vehicles covered approximately 800,000 km and transported 218,000 m³ in 2024. Equivalent to 20 trips around the Earth, demonstrating our commitment to efficient, reliable transport.',
    ...
    'footer.faq': 'FAQ',
    'footer.copyright': '© 2025 Emdad Mubasher. All rights reserved.',
    ...
    // Quality Page
    'quality.hero.title': 'Trusted Quality Standards',
    'quality.hero.subtitle':"At Emdad, we set higher standards in logistics, ensuring reliable quality and efficiency.",
  ...
  ar: {
    ...
    // Hero Section
    'hero.title': 'إمداد مباشر',
    'hero.company': 'لنقل النفط الخام والمشتقات النفطية محدودة المسؤولية',
    ...
    // About Section
    'about.title': 'حول إمداد مباشر',
    'about.description': 'تأسست إمداد مباشر في عام 2019، وتتخصص في نقل النفط في سوريا، ملتزمة بتقديم حلول نقل آمنة وفعالة تلبي احتياجات السوق والعملاء.',
    ...
    // Numbers Section
    'numbers.title': 'إمداد مباشر بالأرقام',
    'numbers.description': 'قطعت مركبات إمداد مباشر حوالي 800,000 كم ونقلت 218,000 متر مكعب في عام 2024. ما يعادل 20 رحلة حول الأرض، مما يدل على التزامنا بالنقل الفعال والموثوق.',

    // Updated Why Choose Emdad Section with Arabic translations
    'whyEmdad.title': 'لماذا إمداد مباشر؟',
    ...
    // About Page
    'aboutPage.hero.title': 'حول إمداد مباشر',
    'aboutPage.hero.subtitle': 'قيادة مستقبل نقل النفط في سوريا',
    'aboutPage.company.title': 'شركتنا',
    'aboutPage.company.description': 'شركة إمداد مباشر لنقل وتخزين المنتجات النفطية، تأسست في عام 2019، ملتزمة بتقديم خدمات نقل النفط المتميزة مع التركيز على السلامة والكفاءة والنمو الاستراتيجي في سوريا والمنطقة المحيطة.',
    'aboutPage.foundation.title': 'التأسيس',
    'aboutPage.foundation.description': 'تأسست في عام 2019 باستراتيجية واضحة وفريق ذو خبرة، نمت إمداد مباشر بسرعة لتصبح إحدى الشركات الرئيسية في صناعة نقل النفط في سوريا.',
    ...
    'footer.copyright': '© 2025 إمداد مباشر. جميع الحقوق محفوظة.',
    ...
    'faq.question1': 'ما هي الخدمات التي تقدمها إمداد مباشر؟',
    'faq.answer1': '.تتخصص إمداد مباشر في نقل المنتجات النفطية، وتقدم حلول لوجستية آمنة وفعالة لتوزيع الوقود في جميع أنحاء سوريا. نقدم خدمات نقل شاملة مع إدارة حديثة للأسطول والالتزام ببروتوكولات السلامة',
    ...
    'faq.question5': 'ما الذي يميز إمداد مباشر عن المنافسين؟',
    'faq.answer5': 'تتميز إمداد مباشر من خلال التزامنا بالسلامة والموثوقية والكفاءة. نجمع بين التكنولوجيا الحديثة والمهنيين ذوي الخبرة لتقديم جودة خدمة فائقة والحفاظ على شراكات طويلة الأمد مع عملائنا.',
    ...
    // Quality Page Arabic
    'quality.hero.title':'معايير جودة موثوقة',
"quality.hero.subtitle": "في إمداد مباشر نضع معايير أعلى للنقل، ونضمن جودة موثوقة وكفاءة عالية.",    
